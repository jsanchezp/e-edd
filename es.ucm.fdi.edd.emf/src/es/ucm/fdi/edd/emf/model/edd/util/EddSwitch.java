 ...
 * @generated
 */
public class EddSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EddPackage.EDD: {
				EDD edd = (EDD)theEObject;
				T result = caseEDD(edd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EddPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = caseTreeElement(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EddPackage.LEAF: {
				Leaf leaf = (Leaf)theEObject;
				T result = caseLeaf(leaf);
				if (result == null) result = caseTreeElement(leaf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EddPackage.TREE_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EDD</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EDD</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEDD(EDD object) {
		return null;
	}
