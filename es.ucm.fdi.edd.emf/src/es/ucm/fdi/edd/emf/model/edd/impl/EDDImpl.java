...
public class EDDImpl extends MinimalEObjectImpl.Container implements EDD {
	 ...
	 * @ordered
	 */
	protected EList<TreeElement> elements;
	...
	protected EClass eStaticClass() {
		return EddPackage.Literals.EDD;
	}
	 ...
	 * @generated
	 */
	public EList<TreeElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<TreeElement>(TreeElement.class, this, EddPackage.EDD__ELEMENTS);
		}
		return elements;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EddPackage.EDD__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EddPackage.EDD__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends TreeElement>)newValue);
				return;
			case EddPackage.EDD__NAME:
