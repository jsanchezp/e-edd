...
/**
 * Abstract base class for the editor parts that make up the pages of the Ed2 Editor. 
 */
public abstract class Ed2EditorPart extends EditorPart implements IMenuListener, IEditingDomainProvider {

	/**
	 * The "parent" editor that this editor part is embedded into. 
	 */
	protected Ed2Editor parentEditor;
	
	/**
	 * Default constructor.  
	 * @param parent
	 */
	public Ed2EditorPart(Ed2Editor parent) {
		super();
	...
	public void menuAboutToShow(IMenuManager manager) {
		...
		((Ed2ActionBarContributor) ((Ed2MultipageActionBarContributor) parentEditor
