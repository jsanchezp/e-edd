...
import es.ucm.fdi.edd.emf.model.edd.diagram.edit.policies.EddTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TreeElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TreeElementNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new EddTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return EddElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EddParserProvider
					.getParser(
							EddElementTypes.TreeElement_2003,
							getParserElement(),
							EddVisualIDRegistry
									.getType(es.ucm.fdi.edd.emf.model.edd.diagram.edit.parts.TreeElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					EddEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
