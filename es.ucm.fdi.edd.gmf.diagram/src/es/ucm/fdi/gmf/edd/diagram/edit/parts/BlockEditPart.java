...
import es.ucm.fdi.gmf.edd.diagram.edit.policies.BlockItemSemanticEditPolicy;
...
public class BlockEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BlockBlockTreeElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureBlockCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BlockBlockTreeElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BlockBlockTreeElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureBlockCompartmentFigure();
			pane.remove(((BlockBlockTreeElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof BlockBlockTreeElementsCompartmentEditPart) {
	...
	public class BlockFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			this.add(fFigureBlockNameFigure, BorderLayout.TOP);

			fFigureBlockCompartmentFigure = new RectangleFigure();

			this.add(fFigureBlockCompartmentFigure, BorderLayout.CENTER);
