...
import es.ucm.fdi.gmf.edd.diagram.edit.policies.EddTextSelectionEditPolicy;
		...
		if (parser == null) {
			parser = EddParserProvider
					.getParser(
							...
							getParserElement(),
							EddVisualIDRegistry
									.getType(es.ucm.fdi.gmf.edd.diagram.edit.parts.TreeElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
