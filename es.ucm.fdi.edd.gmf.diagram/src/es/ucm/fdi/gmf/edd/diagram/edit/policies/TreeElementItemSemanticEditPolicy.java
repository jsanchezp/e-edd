...
import es.ucm.fdi.gmf.edd.diagram.edit.commands.TreeElementLinksCreateCommand;
import es.ucm.fdi.gmf.edd.diagram.edit.commands.TreeElementLinksReorientCommand;
...
public class TreeElementItemSemanticEditPolicy extends
	...
	public TreeElementItemSemanticEditPolicy() {
		super(EddElementTypes.TreeElement_3002);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (EddElementTypes.TreeElementLinks_4001 == req.getElementType()) {
			return getGEFWrapper(new TreeElementLinksCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case TreeElementLinksEditPart.VISUAL_ID:
			return getGEFWrapper(new TreeElementLinksReorientCommand(req));
		}
