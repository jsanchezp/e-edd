 ...
 * @generated
 */
public class Ed2ViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ModelEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& Ed2VisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Ed2VisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = Ed2VisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!Ed2ElementTypes.isKnownElementType(elementType)
				...
				if (!ModelEditPart.MODEL_ID.equals(Ed2VisualIDRegistry
		...
		return ED2EditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = Ed2VisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != Ed2VisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = Ed2VisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = Ed2VisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ED2EditPart.VISUAL_ID:
		...
		case NodeEditPart.VISUAL_ID:
			return createNode_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case LeafEditPart.VISUAL_ID:
			return createLeaf_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (Ed2VisualIDRegistry.getVisualID(elementTypeHint)) {
		case ED2TreeElementsEditPart.VISUAL_ID:
			return createED2TreeElements_4001(containerView, index, persisted,
					preferencesHint);
		case NodeNodesEditPart.VISUAL_ID:
			return createNodeNodes_4002(containerView, index, persisted,
					preferencesHint);
		case NodeLeavesEditPart.VISUAL_ID:
			return createNodeLeaves_4003(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createED2_2008(EObject domainElement, View containerView,
		...
		node.setType(Ed2VisualIDRegistry.getType(ED2EditPart.VISUAL_ID));
	...
	public Node createNode_2006(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Ed2VisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createLeaf_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Ed2VisualIDRegistry.getType(LeafEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Edge createED2TreeElements_4001(View containerView, int index,
		...
		edge.setType(Ed2VisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createNodeNodes_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Ed2VisualIDRegistry.getType(NodeNodesEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createNodeLeaves_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Ed2VisualIDRegistry.getType(NodeLeavesEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
