 ...
 * @generated
 */
public class NodeNodesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeNodesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return Ed2BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateNodeNodes_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getNodes().add(getTarget());
		}
