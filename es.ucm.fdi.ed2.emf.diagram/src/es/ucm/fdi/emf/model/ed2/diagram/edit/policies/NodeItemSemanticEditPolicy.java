...
import es.ucm.fdi.emf.model.ed2.diagram.edit.commands.NodeNodesCreateCommand;
import es.ucm.fdi.emf.model.ed2.diagram.edit.commands.NodeNodesReorientCommand;
 ...
 * @generated
 */
public class NodeItemSemanticEditPolicy extends Ed2BaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public NodeItemSemanticEditPolicy() {
		super(Ed2ElementTypes.Node_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Ed2VisualIDRegistry.getVisualID(incomingLink) == NodeNodesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Ed2VisualIDRegistry.getVisualID(outgoingLink) == NodeNodesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (Ed2VisualIDRegistry.getVisualID(outgoingLink) == NodeLeavesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Ed2ElementTypes.NodeNodes_4002 == req.getElementType()) {
			return getGEFWrapper(new NodeNodesCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case NodeNodesEditPart.VISUAL_ID:
			return getGEFWrapper(new NodeNodesReorientCommand(req));
