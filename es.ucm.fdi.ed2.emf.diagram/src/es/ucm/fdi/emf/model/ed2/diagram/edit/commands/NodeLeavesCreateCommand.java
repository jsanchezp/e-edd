 ...
 * @generated
 */
public class NodeLeavesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeLeavesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return Ed2BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateNodeLeaves_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getLeaves().add(getTarget());
		}
