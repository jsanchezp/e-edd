...
import es.ucm.fdi.emf.model.ed2.diagram.edit.policies.Ed2TextSelectionEditPolicy;
...
public class NodeNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Ed2TextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return Ed2ElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Ed2ParserProvider
					.getParser(
							Ed2ElementTypes.Node_2006,
							getParserElement(),
							Ed2VisualIDRegistry
									.getType(es.ucm.fdi.emf.model.ed2.diagram.edit.parts.NodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					Ed2EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
