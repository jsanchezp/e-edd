 ...
 * @generated
 */
public class ED2ItemSemanticEditPolicy extends Ed2BaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Ed2VisualIDRegistry.getVisualID(outgoingLink) == ED2TreeElementsEditPart.VISUAL_ID) {
