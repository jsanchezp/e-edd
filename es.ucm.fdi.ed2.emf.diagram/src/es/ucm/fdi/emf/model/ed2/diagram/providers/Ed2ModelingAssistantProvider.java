 ...
 * @generated
 */
public class Ed2ModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog.setMessage(Messages.Ed2ModelingAssistantProviderMessage);
		dialog.setTitle(Messages.Ed2ModelingAssistantProviderTitle);
